game.gui.component.Panel = game.gui.component.Component.extend({
    ...
    init: function (options) {
        var defaults = {
                ...
                height: 0,
                width: 0,
                layout: game.gui.component.Panel.VERTICAL,
    ...
    setX: function (x) {
        ...
        if (this.layout === game.gui.component.Panel.VERTICAL) {
        ...
        if (component != null && component != undefined) {
            if (component instanceof Array) {
                ...
                component.map(function (comp) {
                    ...
                    if (comp instanceof game.gui.component.Button)
    ...
    remove: function (component) {
        ...
        if (component instanceof game.gui.component.Button)
...
game.gui.component.Panel.VERTICAL = 0;
game.gui.component.Panel.HORIZONTAL = 1;